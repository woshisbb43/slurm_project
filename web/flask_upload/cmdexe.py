...
def execute(loadtype):
    if loadtype == 'cpu':
        ...
        ret = subprocess.check_output(["sbatch","-o","/home/ubuntu/slurm.out","/forshow/slurm_project/slurm/jobs/sysbench_cpu.script"])
    elif loadtype == 'mem':
        ret = subprocess.check_output(["sbatch","-o","/home/ubuntu/slurm.out","/forshow/slurm_project/slurm/jobs/sysbench_mem.script"])
        # ret = subprocess.call(CMD_MEM, shell=True)
    else:
        ret = subprocess.check_output(["sbatch","-p","ML","-o","/home/ubuntu/slurm.out","/forshow/slurm_project/slurm/jobs/pytest.sh"])
